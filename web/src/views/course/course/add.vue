    ...
    <el-row :gutter="15">
      <el-form ref="formRef" :model="formData" :rules="rules" size="default" label-width="100px">
        <el-col :span="24">
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="课程编号" prop="field107">
                <el-input v-model="formData.field107" type="text" placeholder="请输入课程编号" clearable
        ...
        <el-col :span="24">
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="课程名称" prop="field110">
                <el-input v-model="formData.field110" type="text" placeholder="请输入课程名称" clearable
                  :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="课程价格" prop="field111">
                <el-input v-model="formData.field111" type="text" placeholder="请输入课程价格" clearable
                  :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="适用人群" prop="field116">
                <el-select v-model="formData.field116" placeholder="请选择适用人群" clearable
                  :style="{width: '100%'}">
        ...
        <el-col :span="24">
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="课程封面" prop="field118" required>
            ...
            <el-col :span="10">
              <el-form-item label="推荐指数" prop="field119">
        ...
        <el-col :span="20">
          <el-row gutter="15">
            <el-col :span="24">
              <el-form-item label="课程介绍" prop="field121">
                <el-input v-model="formData.field121" type="textarea" placeholder="请输入课程介绍"
...
// 上传请求路径
const field118Action = ref('https://jsonplaceholder.typicode.com/posts/')
// 上传文件列表
const field118fileList = ref([])
/**
 * @name: 上传之前的文件判断
 ...
 * @return {*}
 */
function field118BeforeUpload(file) {
